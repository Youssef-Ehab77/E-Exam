...
CREATE TABLE `student_has_exam` (
  ...
  KEY `fk_student_has_exam_student1_idx` (`student_id`),
  CONSTRAINT `fk_student_has_exam_exam1` FOREIGN KEY (`exam_id`) REFERENCES `exam` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_student_has_exam_student1` FOREIGN KEY (`student_id`) REFERENCES `student` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
